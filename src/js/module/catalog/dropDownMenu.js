// get constants
const {catalogMenuItem} = require('../constants/root');
    ...
    if(catalogItem.classList.contains('menu-catalog__item_active')) {
        ...
        // highlighting the parent subitem contained in the parent item     
            ...
            if(childItemsActive.length) {
                ...
                const itemActive = childItemActive.querySelector('.menu-catalog__title') || childItemActive.querySelector('.menu-catalog__link');
